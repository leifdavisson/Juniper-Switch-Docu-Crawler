...
def download_oui_db():
    ...
    # Ensure secure HTTPS connections to prevent Man-in-the-Middle (MitM) attacks
    url = "https://standards-oui.ieee.org/oui/oui.txt"
    print("Downloading IEEE OUI Registry (approx 5MB)...")
    try:
        # Avoid standard browser User-Agents which are blocked with HTTP 418 by the server
