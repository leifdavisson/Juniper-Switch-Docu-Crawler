...
def sanitize_filename(filename):
    """Sanitize the input to prevent path traversal vulnerabilities."""
...
def crawl_device(ip, ports, username, password, timestamp):
    ...
    try:
        ...
        safe_hostname = sanitize_filename(filename_hostname)
        backup_filename = f"{safe_hostname}_backup_{timestamp}.cfg"
